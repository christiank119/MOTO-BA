# MOTO - Room and Attendance Management System

MOTO is a comprehensive room and attendance management system designed for educational institutions. It tracks students and staff using NFC technology as they move between different rooms and activities.

## Features

- 🏫 **Room Management**: Track room usage, capacity, and availability
- 👤 **User Management**: Manage students and staff with NFC identification
- 📝 **Activity Tracking**: Create and manage educational activities
- ✅ **Attendance Tracking**: Monitor student attendance in real-time
- 📊 **Feedback Collection**: Gather daily feedback from students

## System Architecture

The system consists of three primary components:

1. **Django Backend**: RESTful API server
2. **Native GTK App**: Desktop application for tablets
...
- For development: Python 3.12, Git
