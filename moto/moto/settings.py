"""
Django settings for MOTO project with improved security.
"""
...
# Get secret key from environment variable, or use fallback for development only
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-w0g1-bq#19dk+wbo@wu2&9o%!3)*!fw$!f-cibuocj42yxkb$+')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'moto'),
